...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-28 right-8 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center p-4 transition-all hover:scale-110"
